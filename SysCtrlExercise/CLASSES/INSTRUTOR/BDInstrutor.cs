    ...
    class BDInstrutor
    {
        ...
        ********************************************************************/
        public int Incluir(Instrutor pobj_Instrutor)
        {
            ...
            obj_Pessoa.Nm_Pessoa = pobj_Instrutor.Nm_Pessoa;
            obj_Pessoa.Gen_Pessoa = pobj_Instrutor.Gen_Pessoa;
            obj_Pessoa.CPF_Pessoa = pobj_Instrutor.CPF_Pessoa;
            obj_Pessoa.Cel_Pessoa = pobj_Instrutor.Cel_Pessoa;
            obj_Pessoa.Mail_Pessoa = pobj_Instrutor.Mail_Pessoa;
            obj_Pessoa.End_Pessoa = pobj_Instrutor.End_Pessoa;
            obj_Pessoa.Bai_Pessoa = pobj_Instrutor.Bai_Pessoa;
            obj_Pessoa.Cid_Pessoa = pobj_Instrutor.Cid_Pessoa;
            obj_Pessoa.UF_Pessoa = pobj_Instrutor.UF_Pessoa;
            obj_Pessoa.CEP_Pessoa = pobj_Instrutor.CEP_Pessoa;

            obj_Pessoa.Cod_Pessoa = obj_BDPessoa.Incluir(obj_Pessoa);

            pobj_Instrutor.Cod_Pessoa = obj_Pessoa.Cod_Pessoa;
        ...
        ********************************************************************/
        public bool Alterar(Instrutor pobj_Instrutor)
        {
            if (pobj_Instrutor.Cod_Instrutor != -1)
            {
                ...
                obj_Pessoa.UF_Pessoa = pobj_Instrutor.UF_Pessoa;
                obj_Pessoa.CEP_Pessoa = pobj_Instrutor.CEP_Pessoa;
                obj_Pessoa.Cod_Pessoa = pobj_Instrutor.Cod_Pessoa;
        ...
        public Instrutor FindByCod(Instrutor pobj_Instrutor)
        {
            ...
            try
            {
                ...
                if (obj_Dtr.HasRows)
                {
                    ...
                    pobj_Instrutor.Nm_Pessoa = obj_Pessoa.Nm_Pessoa;
                    pobj_Instrutor.Gen_Pessoa = obj_Pessoa.Gen_Pessoa;
                    pobj_Instrutor.CPF_Pessoa = obj_Pessoa.CPF_Pessoa;
                    pobj_Instrutor.Cel_Pessoa = obj_Pessoa.Cel_Pessoa;
                    pobj_Instrutor.Mail_Pessoa = obj_Pessoa.Mail_Pessoa;
                    pobj_Instrutor.End_Pessoa = obj_Pessoa.End_Pessoa;
                    pobj_Instrutor.Bai_Pessoa = obj_Pessoa.Bai_Pessoa;
                    pobj_Instrutor.Cid_Pessoa = obj_Pessoa.Cid_Pessoa;
                    pobj_Instrutor.UF_Pessoa = obj_Pessoa.UF_Pessoa;
                    pobj_Instrutor.CEP_Pessoa = obj_Pessoa.CEP_Pessoa;
            ...
            try
            {
                ...
                if (obj_Dtr.HasRows)
                {
                    while (obj_Dtr.Read())
                    {
                        ...
                        obj_Pessoa.Cod_Pessoa = obj_Instrutor.Cod_Pessoa;

                        obj_Pessoa = obj_BDPessoa.FindByCod(obj_Pessoa);


                        obj_Instrutor.Nm_Pessoa = obj_Pessoa.Nm_Pessoa;
                        obj_Instrutor.Gen_Pessoa = obj_Pessoa.Gen_Pessoa;
                        obj_Instrutor.CPF_Pessoa = obj_Pessoa.CPF_Pessoa;
                        obj_Instrutor.Cel_Pessoa = obj_Pessoa.Cel_Pessoa;
                        obj_Instrutor.Mail_Pessoa = obj_Pessoa.Mail_Pessoa;
                        obj_Instrutor.End_Pessoa = obj_Pessoa.End_Pessoa;
                        obj_Instrutor.Bai_Pessoa = obj_Pessoa.Bai_Pessoa;
                        obj_Instrutor.Cid_Pessoa = obj_Pessoa.Cid_Pessoa;
                        obj_Instrutor.UF_Pessoa = obj_Pessoa.UF_Pessoa;
                        obj_Instrutor.CEP_Pessoa = obj_Pessoa.CEP_Pessoa;
