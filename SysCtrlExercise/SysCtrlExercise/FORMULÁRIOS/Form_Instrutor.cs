...
namespace SysCtrlExercise
{
    public partial class Frm_Instrutor : Form
    {
        ...
        private void lbox_Instrutor_Click(object sender, EventArgs e)
        {
        ...
        private void PopulaLista()
        {
            ...
            if (obj_Lista != null)
            {
                ...
                for (int i = 0; i < obj_Lista.Count; i++)
                {
                    ...
                    lbox_Instrutors.Items.Add(obj_Lista[i].Cod_Instrutor.ToString() + "-" + obj_Pessoa.Nm_Pessoa);
                }
            }
        ...
        ********************************************************************/
        private void PopulaForm(Instrutor pobj_Instrutor)
        {
            ...
            chbox_Manha.Checked = pobj_Instrutor.Per_Instrutor.Substring(0, 1) == "1";
            chbox_Tarde.Checked = pobj_Instrutor.Per_Instrutor.Substring(1, 1) == "1";
            chbox_Noite.Checked = pobj_Instrutor.Per_Instrutor.Substring(2, 1) == "1";
